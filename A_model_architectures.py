...
class DataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        return torch.utils.data.DataLoader(train_set, batch_size=self.batch_size, shuffle=True, num_workers=4)
